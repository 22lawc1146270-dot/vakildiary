...
fun AddCaseScreen(
    ...
    LaunchedEffect(
        ...
        prefillCaseType,
        prefillCaseStage,
        prefillEcourtStateCode,
        prefillEcourtDistrictCode,
        prefillEcourtCourtCode,
        prefillEcourtCaseTypeCode,
        prefillEcourtYear
    ) {
        if (
            !prefillCaseName.isNullOrBlank() ||
            !prefillCaseNumber.isNullOrBlank() ||
            !prefillCourtName.isNullOrBlank() ||
            !prefillClientName.isNullOrBlank() ||
            prefillCourtType != null ||
            prefillCaseType != null ||
            prefillCaseStage != null
        ) {
            viewModel.prefill(
        ...
        if (!prefillEcourtStateCode.isNullOrBlank() &&
            !prefillEcourtDistrictCode.isNullOrBlank() &&
            !prefillEcourtCourtCode.isNullOrBlank() &&
            !prefillEcourtCaseTypeCode.isNullOrBlank() &&
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                ...
                Text(text = if (uiState is AddCaseUiState.Loading) "Saving..." else "Save")
            }
        }
    }
}
